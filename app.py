...
# HARVEST REMINDER
# =====================================
st.markdown("## ⏰ Harvest Reminder")

days = st.number_input(
    "Enter Estimated Harvest Days",
    min_value=1,
    max_value=365,
    value=7
)
...
if st.button("Create Harvest Reminder"):
    ...
    st.success(
        f"🌾 Estimated Harvest Date: {future_date.strftime('%d-%m-%Y')}"
    )
...
# WATERING REMINDER
# =====================================
st.markdown("## 💧 Smart Watering Reminder")
...
if st.button("Get Watering Advice"):
    ...
    if rain_level < 40:
        ...
        st.warning(
            ...
            💧 Water your {crop_type} plants tomorrow morning.
            """
        )
        ...
        st.success(
            ...
            🌧️ No watering needed for {crop_type} today.
            """
        )
...
user_input = st.chat_input("Ask farming questions...")
